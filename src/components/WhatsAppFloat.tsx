...
export default function WhatsAppFloat({
  ...
  return (
    <a
      ...
      className="group fixed right-5 z-50 hidden items-center gap-2.5 rounded-full bg-[#25D366] py-3 pl-4 pr-6 text-white shadow-float transition-all duration-300 hover:-translate-y-1 hover:shadow-soft md:flex md:right-7"
    >
      ...
      <span className="text-[15px] font-semibold">Pedir por WhatsApp</span>
    </a>
  );
}
