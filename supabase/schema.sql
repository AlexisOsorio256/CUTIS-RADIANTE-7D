...
('kit-completo','Kit Completo','Cutis Radiante 7D 💗','Todo lo que necesitas para tu rutina completa de cuidado facial ✨', 750, '/images/kit-facial.jpg', '{}', '{}', '[{"label":"Presentación","value":"Kit de 5 piezas"}]'::jsonb, array['🧴 Exfoliante Aclarante de Arroz','🧼 Jabón','✨ Crema Reparadora','✨ Crema Ultra Master Aclarante','☀️ Bloqueador Solar FPS 75'], 'Quiero apartar mi kit', 'Hola, quiero apartar mi KIT COMPLETO 💗 ¿Me ayudas con mi pedido?', 6);
